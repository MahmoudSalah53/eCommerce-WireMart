...
@section('admin_page_title', 'Your Profile')
        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-4 pb-2">
                    <div class="row">
                        <div class="col-md-4 text-center" style=" width: 400px; height: 350px;" >        
                                @if($user->images->isNotEmpty())
                                <img src="{{ asset('storage/' . $user->images->first()->img_path) }}" alt="profile_image" style="width: 100%;">
                                @else
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mt-4">
                                <button class="btn btn-primary" onclick="openEditModal()">@lang('messages.editProfile')</button>
                                <button class="btn btn-outline-secondary" onclick="openPassModal()">@lang('messages.editPass')</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.passwordupdate', $user->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">

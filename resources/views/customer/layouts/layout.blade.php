		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="{{route('dashboard')}}">
					<span class="align-middle">@lang('messages.customerDash')</span>
				</a>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item {{request()->routeIs('customer.history') ? 'active' : ''}}">
						<a class="sidebar-link" href="{{route('customer.history')}}">
							<i class="align-middle" data-feather="clock"></i> <span class="align-middle">@lang('messages.orderHistory')</span>
						</a>
					</li>

					<li class="sidebar-item {{request()->routeIs('customer.payment') ? 'active' : ''}}">
						<a class="sidebar-link" href="{{route('customer.payment')}}">
							<i class="align-middle" data-feather="credit-card"></i> <span class="align-middle">@lang('messages.payment')</span>
						</a>
					</li>
					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="{{route('customer.profile')}}"><i class="align-middle me-1" data-feather="user"></i>@lang('messages.profile')</a>

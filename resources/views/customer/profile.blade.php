...
@section('customer_page_title', 'Your Profile')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('customer.profileupdate', $user->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
...
<div id="editPasswordModal" class="modal-overlay">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('customer.passwordupdate', $user->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
